    ...
    protected function processTags($commentStart, $commentEnd)
    {
        ...
        $tags = array(
                 ...
                 'package'    => array(
                                  'required'       => true,
                                  'allow_multiple' => false,
                                  'order_text'     => 'follows @category (if used)',
                                 ),
                 'subpackage' => array(
                                  'required'       => false,
                                  'allow_multiple' => false,
                 ...
                 'version'    => array(
                                  'required'       => true,
                                  'allow_multiple' => false,
                                  'order_text'     => 'follows @licence (if used) or @copyright (if used) or @author',
                                 ),
                 'link'       => array(
                                  'required'       => false,
                                  'allow_multiple' => true,
                 ...
                 'see'        => array(
                                  'required'       => false,
                                  'allow_multiple' => true,
                                  'order_text'     => 'follows @link (if used) or @version',
                                 ),
                 'since'      => array(
                                  'required'       => false,
                                  'allow_multiple' => false,
                                  'order_text'     => 'follows @see (if used) or @link (if used) or @version',
                                 ),
                 'deprecated' => array(
                                  'required'       => false,
                                  'allow_multiple' => false,
                                  'order_text'     => 'follows @since (if used) or @see (if used) or @link (if used) or @version',
                                 ),
                );
